...
{
    // nr, progressive, obe name, w, h, cap enum, encoder enum, denomintator, numerator, encoder enum fps, human name
    // VEGA doesn't support a GOP Size of 50, odd I know.
    // Vega wants the codec for interlaced modes to be set to FIELDS per second.
    {  0, 0, INPUT_VIDEO_FORMAT_PAL,          720,  576,  API_VEGA3311_CAP_RESOLUTION_720x576,   API_VENC_RESOLUTION_720x576,   1000, 25000, API_VEGA_BQB_FPS_25,    "720x576i25",      API_VEGA_BQB_GOP_SIZE_25 },
    {  1, 0, INPUT_VIDEO_FORMAT_NTSC,         720,  480,  API_VEGA3311_CAP_RESOLUTION_720x480,   API_VENC_RESOLUTION_720x480,   1001, 30000, API_VEGA_BQB_FPS_29_97, "720x480p29.97",   API_VEGA_BQB_GOP_SIZE_30 },
    //
    { 10, 1, INPUT_VIDEO_FORMAT_720P_50,     1280,  720,  API_VEGA3311_CAP_RESOLUTION_1280x720,  API_VENC_RESOLUTION_1280x720,  1000, 50000, API_VEGA_BQB_FPS_50,    "1280x720p50",     API_VEGA_BQB_GOP_SIZE_60 },
    { 11, 1, INPUT_VIDEO_FORMAT_720P_5994,   1280,  720,  API_VEGA3311_CAP_RESOLUTION_1280x720,  API_VENC_RESOLUTION_1280x720,  1001, 60000, API_VEGA_BQB_FPS_59_94, "1280x720p59.94",  API_VEGA_BQB_GOP_SIZE_60 },
    { 12, 1, INPUT_VIDEO_FORMAT_720P_60,     1280,  720,  API_VEGA3311_CAP_RESOLUTION_1280x720,  API_VENC_RESOLUTION_1280x720,  1000, 60000, API_VEGA_BQB_FPS_60,    "1280x720p60",     API_VEGA_BQB_GOP_SIZE_60 },
    //
    { 20, 0, INPUT_VIDEO_FORMAT_1080I_50,    1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1000, 25000, API_VEGA_BQB_FPS_50,    "1920x1080i25",    API_VEGA_BQB_GOP_SIZE_25 },
    { 21, 0, INPUT_VIDEO_FORMAT_1080I_5994,  1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1001, 30000, API_VEGA_BQB_FPS_59_94, "1920x1080i29.97", API_VEGA_BQB_GOP_SIZE_30 },
    //
    { 30, 1, INPUT_VIDEO_FORMAT_1080P_24,    1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1000, 24000, API_VEGA_BQB_FPS_24,    "1920x1080p24",    API_VEGA_BQB_GOP_SIZE_24 },
    { 31, 1, INPUT_VIDEO_FORMAT_1080P_25,    1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1000, 25000, API_VEGA_BQB_FPS_25,    "1920x1080p25",    API_VEGA_BQB_GOP_SIZE_25 },
    { 32, 1, INPUT_VIDEO_FORMAT_1080P_2997,  1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1001, 30000, API_VEGA_BQB_FPS_29_97, "1920x1080p29.97", API_VEGA_BQB_GOP_SIZE_30 },
    { 33, 1, INPUT_VIDEO_FORMAT_1080P_30,    1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1000, 30000, API_VEGA_BQB_FPS_30,    "1920x1080p30",    API_VEGA_BQB_GOP_SIZE_30 },
    { 34, 1, INPUT_VIDEO_FORMAT_1080P_50,    1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1000, 50000, API_VEGA_BQB_FPS_50,    "1920x1080p50",    API_VEGA_BQB_GOP_SIZE_60 },
    { 35, 1, INPUT_VIDEO_FORMAT_1080P_5994,  1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1001, 60000, API_VEGA_BQB_FPS_59_94, "1920x1080p59.94", API_VEGA_BQB_GOP_SIZE_60 },
    { 36, 1, INPUT_VIDEO_FORMAT_1080P_60,    1920, 1080,  API_VEGA3311_CAP_RESOLUTION_1920x1080, API_VENC_RESOLUTION_1920x1080, 1000, 60000, API_VEGA_BQB_FPS_60,    "1920x1080p60",    API_VEGA_BQB_GOP_SIZE_60 },
    //
    { 40, 1, INPUT_VIDEO_FORMAT_2160P_25,    3840, 2160,  API_VEGA3311_CAP_RESOLUTION_3840x2160, API_VENC_RESOLUTION_3840x2160, 1000, 25000, API_VEGA_BQB_FPS_25,    "3840x2160p25",    API_VEGA_BQB_GOP_SIZE_25 },
    { 41, 1, INPUT_VIDEO_FORMAT_2160P_2997,  3840, 2160,  API_VEGA3311_CAP_RESOLUTION_3840x2160, API_VENC_RESOLUTION_3840x2160, 1001, 30000, API_VEGA_BQB_FPS_29_97, "3840x2160p29.97", API_VEGA_BQB_GOP_SIZE_30 },
    { 42, 1, INPUT_VIDEO_FORMAT_2160P_30,    3840, 2160,  API_VEGA3311_CAP_RESOLUTION_3840x2160, API_VENC_RESOLUTION_3840x2160, 1000, 30000, API_VEGA_BQB_FPS_30,    "3840x2160p30",    API_VEGA_BQB_GOP_SIZE_30 },
    { 43, 1, INPUT_VIDEO_FORMAT_2160P_50,    3840, 2160,  API_VEGA3311_CAP_RESOLUTION_3840x2160, API_VENC_RESOLUTION_3840x2160, 1000, 50000, API_VEGA_BQB_FPS_50,    "3840x2160p50",    API_VEGA_BQB_GOP_SIZE_60 },
    { 44, 1, INPUT_VIDEO_FORMAT_2160P_5994,  3840, 2160,  API_VEGA3311_CAP_RESOLUTION_3840x2160, API_VENC_RESOLUTION_3840x2160, 1001, 60000, API_VEGA_BQB_FPS_59_94, "3840x2160p59.94", API_VEGA_BQB_GOP_SIZE_60 },
    { 45, 1, INPUT_VIDEO_FORMAT_2160P_60,    3840, 2160,  API_VEGA3311_CAP_RESOLUTION_3840x2160, API_VENC_RESOLUTION_3840x2160, 1000, 60000, API_VEGA_BQB_FPS_60,    "3840x2160p60",    API_VEGA_BQB_GOP_SIZE_60 },
};
