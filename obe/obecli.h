...
static const obecli_format_name_t format_names[] =
{
    ...
    { VIDEO_AVC_GPU_VAAPI_AVCODEC, "AVC",      "Advanced Video Coding", "VAAPI AVC decoder","avcodec GPU encoder" },
    ...
    { AUDIO_AC_3_BITSTREAM,   "A52",       "ATSC A/52B / AC-3 Bitstream Passthrough", "N/A", "N/A" },
...
static const obecli_output_name_t output_names[] =
{
    ...
    { OUTPUT_SRT, "SRT",  "MPEG-TS via SRT protocol", "internal" },
    { 0, 0, 0, 0 },
};
#endif
